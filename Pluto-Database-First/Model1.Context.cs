...
namespace Pluto_Database_First
{
    ...
    public partial class plutoContext : DbContext
    {
        ...
        [DbFunction("plutoContext", "GetAuthorCourses")]
        public virtual IQueryable<funcGetAuthorCourses_Result> GetAuthorCourses(Nullable<int> authorID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<funcGetAuthorCourses_Result>("[plutoContext].[GetAuthorCourses](@AuthorID)", authorIDParameter);
        }
